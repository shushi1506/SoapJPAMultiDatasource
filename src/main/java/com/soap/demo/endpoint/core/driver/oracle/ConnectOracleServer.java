package com.soap.demo.endpoint.core.driver.oracle;
...
//            connection.close();
    ...
    public static Connection getConnectionOracleQLTB() {
        ConnectOracleServer connectOracleServer = new ConnectOracleServer();
        return connectOracleServer.connected(DefinedConfig.DB_ORACLE_QLTB_URL, DefinedConfig.DB_ORACLE_QLTB_USER, DefinedConfig.DB_ORACLE_QLTB_PASS);
    }
}
