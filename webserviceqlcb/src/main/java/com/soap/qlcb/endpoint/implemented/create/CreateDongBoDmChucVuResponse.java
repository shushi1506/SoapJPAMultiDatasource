...
public class CreateDongBoDmChucVuResponse {
    ...
    public CreateDongBoDmChucVuResponse() {
    }

    public CreateDongBoDmChucVuResponse(String errorCode, String errorMessage, boolean status) {
