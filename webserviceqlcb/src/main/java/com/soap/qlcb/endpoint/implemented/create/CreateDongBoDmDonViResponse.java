...
public class CreateDongBoDmDonViResponse {
    ...
    public CreateDongBoDmDonViResponse() {
    }

    public CreateDongBoDmDonViResponse(String errorCode, String errorMessage, boolean status) {
