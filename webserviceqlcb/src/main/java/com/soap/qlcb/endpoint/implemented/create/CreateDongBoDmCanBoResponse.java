...
public class CreateDongBoDmCanBoResponse {
    ...
    public CreateDongBoDmCanBoResponse() {
    }

    public CreateDongBoDmCanBoResponse(String errorCode, String errorMessage, boolean status) {
