...
public class DmDonViEntityFix {
    ...
    @Basic
    @Column(name = "MA_TST")
    public String getMaTst() {
        return maTst;
    }

    public void setMaTst(String maTst) {
        this.maTst = maTst;
    }
    ...
    public boolean equals(Object o) {
        ...
        DmDonViEntityFix that = (DmDonViEntityFix) o;
        ...
        if (maTst != null ? !maTst.equals(that.maTst) : that.maTst != null) return false;
        if (maDvi != null ? !maDvi.equals(that.maDvi) : that.maDvi != null) return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (maTst != null ? maTst.hashCode() : 0);
        result = 31 * result + (maDvi != null ? maDvi.hashCode() : 0);
        return result;
    }
}
