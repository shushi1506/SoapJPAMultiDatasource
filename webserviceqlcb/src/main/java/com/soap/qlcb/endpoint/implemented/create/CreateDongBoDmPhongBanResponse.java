...
public class CreateDongBoDmPhongBanResponse {
    ...
    public CreateDongBoDmPhongBanResponse() {
    }

    public CreateDongBoDmPhongBanResponse(String errorCode, String errorMessage, boolean status) {
