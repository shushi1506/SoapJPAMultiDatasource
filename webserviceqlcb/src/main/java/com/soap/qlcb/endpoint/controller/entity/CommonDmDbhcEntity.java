 ...
 */
@Entity
@Table(name = "COMMON_DM_DBHC", schema = "QLTB", catalog = "")
public class CommonDmDbhcEntity {
    private long id;
    private String ten;
    ...
    public boolean equals(Object o) {
        ...
        CommonDmDbhcEntity that = (CommonDmDbhcEntity) o;
        ...
        if (loaiHuyen != null ? !loaiHuyen.equals(that.loaiHuyen) : that.loaiHuyen != null) return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (loaiHuyen != null ? loaiHuyen.hashCode() : 0);
        return result;
    }
}
